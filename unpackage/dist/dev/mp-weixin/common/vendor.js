...
/***/ 12:
/*!*******************************************************************!*\
  !*** /Users/pengboli/Desktop/v积分/xcx/crownCookies/store/index.js ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  actions: {
    ...
    xcxOpenidGet: function xcxOpenidGet() {//获取小程序openid
      var that = this;
          ...
          complete: function complete(res) {
            if (res.errMsg.indexOf('ok') == -1) {
              ...
              uni.checkSession({
                ...
                fail: function fail() {var _this = this;
                  uni.login({
                    success: function success(res) {
                      var params = {
                        'code': res.code,
                      ...
                      uni.request({
                        ...
                        success: function success(res) {
                          // reslove(res.data)
                          console.log(res.data);
                          _this.state.xcxopenid = res.data.data.uinfo.openid;
                          _this.state.session_key = res.data.data.uinfo.session_key;
                        },
                        fail: function fail(err) {
                          reject(err);
                        } });
...
function judgeBusinessCode(data) {
  return new Promise(function (resolve, reject) {
    ...
    if (businessCode == 0) {// 扫码成功 红包
      ...
      var redirectToUrl = "../codeScanned/codeScanned?bizcode=".concat(businessCode);
      ...
      // if (reply.username || result.msg == '重复扫码') { //已填写 或者重复扫码 直接显示 已领取 信息
      if (reply.username) {//已填写 或者重复扫码 直接显示 已领取 信息
        _redirectToUrl = "../submitUserInformation/submitUserInformation?bizcode=".concat(businessCode, "&isGetPrize=true");
      } else {
        if (reply.checkPrizeRecord) {
          ...
          if (expireTimeStatus) {
            _redirectToUrl = "../codeScanned/codeScanned?bizcode=".concat(businessCode);
          } else {
            // redirectToUrl = `../getPrize/getPrize?bizcode=${businessCode}&isGetPrize=false`;
            // 修改原因 中出大奖 也要 走点击抽奖按钮 和 弹出 红包一样
            _redirectToUrl = businessCode;
          }
        } else {
          // redirectToUrl = `../getPrize/getPrize?bizcode=${businessCode}&isGetPrize=false`;
          _redirectToUrl = businessCode;
      ...
      var _redirectToUrl2 = "../blackList/blackList?bizcode=".concat(businessCode);
      ...
      var _redirectToUrl3 = "../index/index?bizcode=".concat(businessCode);
      uni.setStorage({
        key: 'businessCode',
        data: businessCode });

      reject(_redirectToUrl3);
    }
  });
}
...
function judgeBusinessStrCode(data) {
  return new Promise(function (resolve, reject) {
    ...
    if (businessCode == 0) {// 扫码成功 红包
      ...
      var _redirectToUrl4 = "../codeScanned/codeScanned?bizcode=".concat(businessCode);
      resolve(_redirectToUrl4);
    } else if (businessCode == 7 || businessCode == 21) {//大奖 
      var _redirectToUrl5 = '';
      // if (reply.username || result.msg == '重复扫码') { //已填写 或者重复扫码 直接显示 已领取 信息
      if (reply.username) {//已填写 或者重复扫码 直接显示 已领取 信息
        _redirectToUrl5 = "../submitUserInformation/submitUserInformation?bizcode=".concat(businessCode, "&isGetPrize=true");
      } else {
        if (reply.checkPrizeRecord) {
          var expireTime = reply.checkPrizeRecord.expireTime;
          var expireTimeStatus = dateformatTemp(replyTime, expireTime); //返回 false 说明 当前小于活动截止时间 可以正常扫码 如果true说明当前时间大于截止时间不能扫码 跳转至二维码被扫
          ...
          console.log(expireTimeStatus);
          if (expireTimeStatus) {
            _redirectToUrl5 = "../codeScanned/codeScanned?bizcode=".concat(businessCode);
          } else {
            _redirectToUrl5 = "../getPrize/getPrize?bizcode=".concat(businessCode, "&isGetPrize=false");
          }
        } else {
          _redirectToUrl5 = "../getPrize/getPrize?bizcode=".concat(businessCode, "&isGetPrize=false");
        }
      ...
      // 12 展示出入手机号 13 静态页面 提示
      var _redirectToUrl6 = "../blackList/blackList?bizcode=".concat(businessCode);
...
exports.dateformat = dateformat;var dateformatTemp = function dateformatTemp(temp, date1) {
  ...
  return backStatus;
};exports.dateformatTemp = dateformatTemp;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
/***/ 24:
/*!*****************************************************************************!*\
  !*** /Users/pengboli/Desktop/v积分/xcx/crownCookies/common/getWxUserInfor.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.getLocation = getLocation;exports.analysisMobile = analysisMobile;exports.getUserInfo = getUserInfo;exports.callPhone = callPhone;exports.wxScanCode = wxScanCode;exports.getSettingLocation = exports.getOpenid = exports.getCode = exports.checkSession = void 0;
...
var _basicsFun = __webpack_require__(/*! @/common/basicsFun.js */ 23); // 所有获取 微信用户 信息存放
// 获取地理位置信息
...
function sweepQrcode(sendParams) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    var isInitsweepstr = uni.getStorageSync('isInitsweepstr');
...
/***/ 4:
/*!***************************************************************!*\
  !*** /Users/pengboli/Desktop/v积分/xcx/crownCookies/pages.json ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 8:
/*!*****************************************************************!*\
  !*** /Users/pengboli/Desktop/v积分/xcx/crownCookies/utils/api.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.requestGet = requestGet;exports.requestPost = requestPost;exports.getCityInfo = getCityInfo;exports.idcardValidate = exports.config = void 0; // var host = 'https://douban.uieee.com/v2/movie';
...
function requestGet(url) {var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return request(url, 'GET', data);
}
function requestPost(url) {var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
...
/***/ 90:
/*!************************************************************************!*\
  !*** /Users/pengboli/Desktop/v积分/xcx/crownCookies/common/tipConfig.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
